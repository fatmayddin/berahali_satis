        ...
        <div class="grid md:grid-cols-2 gap-10">
            ...
            <div x-data="{ active: 0 }">
                ...
                @if($gallery->isNotEmpty())
                    <p class="text-tagline-2 text-secondary/40 text-center mt-3">
                        * Ortam görselleri temsilidir; ürünün desen ve renkleri etiket bilgileriyle birebir aynıdır.
                    </p>
                @endif
            </div>
            ...
            <div>
                ...
                <div class="mt-6">
                    ...
                    @if(\App\Models\Setting::get('whatsapp'))
                        <a href="https://wa.me/{{ \App\Models\Setting::whatsappNumber() }}?text={{ urlencode('Merhaba 👋 '.$product->name.' ('.$product->code.') hakkında bilgi almak istiyorum: '.url()->current()) }}"
                           target="_blank" rel="noopener"
                           class="mt-3 w-full flex items-center justify-center gap-2 border border-green-500 text-green-600 hover:bg-green-500 hover:text-white font-medium py-3 rounded-full transition">
