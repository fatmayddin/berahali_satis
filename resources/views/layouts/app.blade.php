...
<body class="text-secondary font-sans antialiased flex flex-col min-h-screen"
    ...
    @if(\App\Models\Setting::get('whatsapp'))
        <a href="https://wa.me/{{ \App\Models\Setting::get('whatsapp') }}" target="_blank"
           class="fixed bottom-5 right-5 bg-green-500 hover:bg-green-600 text-white rounded-full p-3.5 shadow-card z-50" title="WhatsApp">
